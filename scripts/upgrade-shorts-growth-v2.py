...
def patch_compose_payload_and_logging(w: dict) -> None:
    ...
    start_compose["parameters"]["jsonBody"] = _unpair("={{ JSON.stringify({ ...$json, policy_version: $('Validate Final Script').item.json.policy_version || 'shorts-growth-v2', outro_experiment_arm: $('Validate Final Script').item.json.outro_experiment_arm || 'no_outro', outro_line: $('Validate Final Script').item.json.outro_line || null }) }}")
